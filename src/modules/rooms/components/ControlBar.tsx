...
function MediaButton({
  ...
  const bg = danger
    ? 'bg-rose-400/25 text-rose-300 hover:bg-rose-400/35'
    : active
  ...
  return (
    <div className="absolute bottom-5 left-1/2 z-10 flex -translate-x-1/2 items-center gap-3 rounded-full border border-auth-input-border bg-auth-surface/95 px-5 py-3 shadow-lg backdrop-blur-md">
      ...
      <button
        ...
        onClick={onLeave}
        className="
          ml-2 flex items-center gap-2 rounded-full bg-rose-400/25 px-5 py-2.5
          text-sm font-semibold text-rose-300 transition-all
          hover:bg-rose-400/35 active:scale-[0.98] cursor-pointer
