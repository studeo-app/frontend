        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          ...
          >
            ...
            <input
              ...
              className="h-11 flex-1 rounded-xl border border-auth-input-border bg-auth-input-bg/40 px-4 text-sm text-auth-title transition placeholder:text-auth-label focus:border-transparent focus:outline-none focus:ring-2 focus:ring-auth-btn"
            />
            <button
              type="submit"
              disabled={!inviteCode.trim() || isJoining}
              className="flex h-11 cursor-pointer items-center gap-2 rounded-xl bg-auth-btn px-5 text-sm font-semibold text-auth-btn-text shadow-md transition hover:brightness-110 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-auth-btn focus-visible:ring-offset-2"
            >
